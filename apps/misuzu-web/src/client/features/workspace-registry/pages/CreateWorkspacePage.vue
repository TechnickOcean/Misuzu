...
<template>
  <AppLayout>
    ...
    <div class="min-h-0 flex flex-1 flex-col overflow-hidden">
      ...
      <section class="min-h-0 flex-1 overflow-y-auto px-3 py-3 md:px-4 md:pb-5">
        <div class="mx-auto w-full max-w-5xl space-y-6">
          <section class="grid gap-3 sm:grid-cols-4">
            <div
              ...
              :class="
                index + 1 <= step ? 'border-foreground bg-secondary' : 'border-border bg-card'
              "
            >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                >
                <template v-else
                  >Review all settings and optionally start flow immediately.</template
                >
              </CardDescription>
            </CardHeader>
